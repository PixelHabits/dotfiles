...
The shared config sets `approval_policy = "never"` and `sandbox_mode = "danger-full-access"`.
Codex runs commands without asking and without a sandbox on every machine that applies this config.
