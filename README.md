...
| [Claude Code](claude.md) | Shared instructions, local state, and local configuration |
| [References](references.md) | Local source checkouts that Claude Code and Codex read from |
